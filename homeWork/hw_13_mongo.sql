// Создать коллекцию products и заполнить документами (6 штук) со следующими свойствами (_id, title, price, count).
...
db.producrs.updateMany({count: {$lt: 10}}, {$set: {count: 10}})


// У всех товаров, цена которых меньше 20000 увеличьте цену на 5000
db.producrs.updateMany({price: {$lt: 20000}}, {$inc: {price: 5000}})
